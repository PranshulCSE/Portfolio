...
export const portfolioData = {
    ...
    about: {
        ...
        stats: [
            { label: 'LeetCode Problems', value: 170, suffix: '+' },
    ...
    experience: [
        {
            ...
            icon: 'briefcase',
            achievements: [
                'Designed and implemented scalable backend architectures and RESTful APIs',
                'Ensured high performance and security for enterprise-level applications',
                'Integrated MongoDB with Node.js & Express.js for dynamic features',
                'Collaborated on production-level full-stack systems'
            ],
        ...
        },
        {
            ...
            icon: 'briefcase',
            achievements: [
                'Built and deployed 2 full-stack MERN applications from scratch',
                'Developed responsive UI and robust backend APIs',
                'Maintained clean codebase using Git & GitHub',
                'Handled deployments and version control efficiently'
            ],
    ...
    skills: {
        ...
        dsaCS: ['Problem Solving', 'OOPS', 'Time Complexity', 'Data Structures'],
        tools: ['Git', 'GitHub', 'VS Code', 'Postman', 'Vercel', 'Netlify', 'Cursor', 'Claude', 'Antigravity'],
        learning: [
            'Advanced MERN Stack Architecture',
            'Backend Performance Optimization',
